...
class JunctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create junction" do
    assert_difference('Junction.count') do
      post junctions_url, params: { junction: { playlist_id: @junction.playlist_id, song_id: @junction.song_id } }, as: :json
    end
  ...
  test "should update junction" do
    patch junction_url(@junction), params: { junction: { playlist_id: @junction.playlist_id, song_id: @junction.song_id } }, as: :json
    assert_response 200
  end
